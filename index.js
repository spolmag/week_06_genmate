...
const Chang = new Beer("Chang", "Beer", 100, 15, "18%");
const orangeJuice = new Juice("Orange juice", "Juice", 50, 8, "Orange");
const CherryBoom = new Juice("Cherry Boom", "Juice", 50, 25, "Cherry");
...
Genmate5shop.addDrink(Chang);
Genmate5shop.addDrink(CherryBoom);
